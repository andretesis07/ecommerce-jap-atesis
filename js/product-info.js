...
document.addEventListener("DOMContentLoaded", function(e){
    getJSONData(PRODUCT_INFO_URL).then(function(resultObj){
        if (resultObj.status === "ok") {
            ...
            productCategoryHTML.innerHTML = product.images;
...
document.addEventListener("DOMContentLoaded", function(e){
    getJSONData(PRODUCT_INFO_COMMENTS_URL).then(function(resultObj){
        if (resultObj.status === "ok") {
            ...
            let commentScore = document.getElementById("commentScore");
            let commentDescription = document.getElementById("commentDescription");
            let commentUser = document.getElementById("commentUser");
            let commentDateTime = document.getElementById("commentDateTime");
